...
export const GAMES: GameConfig[] = [
  {
    ...
    paytable: pt(0.55, 1.45, 2.95, 5.85),
    scatterTrigger: 3,
    bonus: {
      kind: "sticky_multi",
      spins: 10,
      multWeights: [[2, 50], [3, 28], [5, 13], [10, 6], [25, 2.4], [100, 0.6]],
      collectChance: 0.30,
      maxCells: 9,
    },
  },
  ...
  },
  {
    ...
    reels: 5, rows: 3,
    symbolWeights: W_MID,
    paytable: pt(1.00, 2.40, 5.00, 10.0),
    scatterTrigger: 3,
    bonus: {
      kind: "crash_cannon",
      growthPerTick: 0.10,
  ...
  },
  {
    ...
    reels: 5, rows: 3,
    symbolWeights: W_HIGH,
    paytable: pt(0.92, 2.18, 4.55, 9.10),
    scatterTrigger: 3,
    bonus: {
      kind: "three_path",
      paths: [
        { name: "Asgard", spins: 7, startMult: 9, wildBoostX: 2.2 },
        { name: "Midgard", spins: 12, startMult: 4.0, wildBoostX: 1.4 },
        { name: "Helheim", spins: 16, startMult: 1.2, wildBoostX: 0.8, xbombChance: 0.11 },
      ],
    },
  },
  {
    ...
    reels: 5, rows: 3,
    symbolWeights: W_MID,
    paytable: pt(0.62, 1.46, 3.08, 6.16),
    scatterTrigger: 3,
    bonus: {
      kind: "cluster_tumble",
      spins: 7,
